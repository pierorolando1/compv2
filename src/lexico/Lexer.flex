...
"CK" {return new Symbol(sym.END, yyline, yycolumn, yytext());}
...
"FU" {return new Symbol(sym.FU, yyline, yycolumn, yytext());}
...
"NOLA" {return new Symbol(sym.PALABRA_RESERVADA, yyline, yycolumn, yytext());}
