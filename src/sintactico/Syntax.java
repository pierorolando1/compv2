...
public class Syntax extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  public int error_sym() {return 1;}
    ...
    public void ErrorSemanticoTipo(String nombreVariable, String tipoVariable, String tipoValor, int fila, int columna){
        String msg = "Error de tipos en la línea "+ (fila+1) + ", columna "+ columna + ". ";
        msg += "No se puede asignar un valor de tipo '" + tipoValor + "' a la variable '" + nombreVariable + "' de tipo '" + tipoVariable + "'";
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Syntax$act_num)
		...
		Symbol exp = (Symbol)((java_cup.runtime.Symbol) CUP$Syntax$stack.elementAt(CUP$Syntax$top-1)).value;
                        ...
                        Variable variable = tablaSimbolos.getVariableEnTabla(id.toString(), "Global");
                        if(variable != null && exp != null) {
                            TipoDato tipoVariable = variable.getTipoDato();
                            TipoDato tipoValor = tablaSimbolos.obtenerTipoValor(exp.value);
                            
                            if(!tablaSimbolos.sonTiposCompatibles(tipoVariable, tipoValor)) {
                                String tipoVarStr = tipoVariable != null ? tipoVariable.toString().toLowerCase() : "desconocido";
		...
		Symbol exp = (Symbol)((java_cup.runtime.Symbol) CUP$Syntax$stack.peek()).value;
                        ...
                        // Validar tipos antes de aplicar la operación
                        Variable variable = tablaSimbolos.getVariableEnTabla(id.toString(), "Global");
                        if(variable != null && op != null && exp != null) {
                            TipoDato tipoVariable = variable.getTipoDato();
                            TipoDato tipoValor = tablaSimbolos.obtenerTipoValor(exp.value);
                            
                            // Para operaciones aritméticas, ambos operandos deben ser numéricos
                            ...
                            if(!tipoVariableNumerico || !tipoValorNumerico) {
                                String tipoVarStr = tipoVariable != null ? tipoVariable.toString().toLowerCase() : "desconocido";
                                String tipoValStr = tipoValor != null ? tipoValor.toString().toLowerCase() : "desconocido";
                                ErrorSemanticoTipo(id.toString(), tipoVarStr, tipoValStr, idleft, idright);
                            } else {
		...
		Symbol __oa = (Symbol)((java_cup.runtime.Symbol) CUP$Syntax$stack.peek()).value;
                        ...
                        // Validar que la variable sea de tipo numérico para incremento/decremento
                        Variable variable = tablaSimbolos.getVariableEnTabla(id.toString(), "Global");
                        if(variable != null) {
                            TipoDato tipoVariable = variable.getTipoDato();
                            ...
                            if(!tipoNumerico) {
                                String tipoVarStr = tipoVariable != null ? tipoVariable.toString().toLowerCase() : "desconocido";
                                ErrorSemanticoTipo(id.toString(), tipoVarStr, "numérico (para incremento/decremento)", idleft, idright);
                            } else {
		...
		Object id = (Object)((java_cup.runtime.Symbol) CUP$Syntax$stack.peek()).value;
                        ...
                        if(variable != null) {
                            ...
                            if(!tipoNumerico) {
                                String tipoVarStr = tipoVariable != null ? tipoVariable.toString().toLowerCase() : "desconocido";
                                ErrorSemanticoTipo(id.toString(), tipoVarStr, "numérico (para incremento/decremento)", __oaleft, __oaright);
                            } else {
                                pilaSemantica.push_init(__oa.value.toString());
                                pilaSemantica.push_init(id.toString());
		...
		Symbol _oa = (Symbol)((java_cup.runtime.Symbol) CUP$Syntax$stack.peek()).value;
                        ...
                        // Validar tipos: tanto la variable destino como la fuente deben ser numéricas
                        Variable varDestino = tablaSimbolos.getVariableEnTabla(id1.toString(), "Global");
                        Variable varFuente = tablaSimbolos.getVariableEnTabla(id2.toString(), "Global");
                        
                        if(varDestino != null && varFuente != null) {
                            TipoDato tipoDestino = varDestino.getTipoDato();
                            TipoDato tipoFuente = varFuente.getTipoDato();
                            
                            boolean tipoDestinoNumerico = (tipoDestino == TipoDato.INT || tipoDestino == TipoDato.SHORTINT || 
                                                         tipoDestino == TipoDato.LONGINT || tipoDestino == TipoDato.REAL);
                            boolean tipoFuenteNumerico = (tipoFuente == TipoDato.INT || tipoFuente == TipoDato.SHORTINT || 
                                                        tipoFuente == TipoDato.LONGINT || tipoFuente == TipoDato.REAL);
                            
                            if(!tipoFuenteNumerico) {
                                String tipoFuenteStr = tipoFuente != null ? tipoFuente.toString().toLowerCase() : "desconocido";
                                ErrorSemanticoTipo(id2.toString(), tipoFuenteStr, "numérico (para incremento/decremento)", id2left, id2right);
                            } else if(!tablaSimbolos.sonTiposCompatibles(tipoDestino, tipoFuente)) {
                                String tipoDestinoStr = tipoDestino != null ? tipoDestino.toString().toLowerCase() : "desconocido";
                                String tipoFuenteStr = tipoFuente != null ? tipoFuente.toString().toLowerCase() : "desconocido";
                                ErrorSemanticoTipo(id1.toString(), tipoDestinoStr, tipoFuenteStr, id1left, id1right);
                            } else {
                                ...
                                Variable varFuenteActual = tablaSimbolos.getVariableEnTabla(id2.toString(), "Global");
                                if(varFuenteActual != null) {
                                    Object valorAnterior = varFuenteActual.getValor();
		...
		Object id2 = (Object)((java_cup.runtime.Symbol) CUP$Syntax$stack.peek()).value;
                        ...
                        if(varDestino != null && varFuente != null) {
                            ...
                            if(!tipoFuenteNumerico) {
                                ...
                                Variable varFuenteActual = tablaSimbolos.getVariableEnTabla(id2.toString(), "Global");
                                if(varFuenteActual != null) {
                                    Object valorNuevo = varFuenteActual.getValor();
